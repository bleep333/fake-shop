...
const products = [
  // Mens products
  { name: 'Classic White Tee', sku: 'M-001', price: 29.99, originalPrice: null, category: 't-shirts', gender: 'mens', image: getImagePath('Classic White Tee', 'mens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 1) },
  { name: 'Slim Fit Jeans', sku: 'M-002', price: 79.99, originalPrice: 99.99, category: 'jeans', gender: 'mens', image: getImagePath('Slim Fit Jeans', 'mens'), tags: ['Sale'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 6) },
  { name: 'Denim Jacket', sku: 'M-003', price: 89.99, originalPrice: null, category: 'jackets', gender: 'mens', image: getImagePath('Denim Jacket', 'mens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 5) },
  ...
  { name: 'Hooded Sweatshirt', sku: 'M-006', price: 59.99, originalPrice: 79.99, category: 'hoodies', gender: 'mens', image: getImagePath('Hooded Sweatshirt', 'mens'), tags: ['Sale'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 7) },
  ...
  { name: 'Bomber Jacket', sku: 'M-011', price: 99.99, originalPrice: null, category: 'jackets', gender: 'mens', image: '/images/products/MENS-jacket-bomber', tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 6) },
  { name: 'Cardigan', sku: 'M-012', price: 74.99, originalPrice: null, category: 'knitwear', gender: 'mens', image: '/images/products/MENS-knitwear-cardigan', tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 7) },
  { name: 'Crewneck Sweater', sku: 'M-013', price: 69.99, originalPrice: null, category: 'knitwear', gender: 'mens', image: '/images/products/MENS-knitwear-crewneck', tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 8) },
  { name: 'Athletic Shorts', sku: 'M-014', price: 34.99, originalPrice: null, category: 'shorts', gender: 'mens', image: '/images/products/MENS-shorts-athletic', tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 10) },
  { name: 'Chino Shorts', sku: 'M-015', price: 44.99, originalPrice: null, category: 'shorts', gender: 'mens', image: '/images/products/MENS-shorts-chino', tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 9) },
  
  // Womens products
  { name: 'Floral Summer Dress', sku: 'W-001', price: 89.99, originalPrice: null, category: 'dresses', gender: 'womens', image: getImagePath('Floral Summer Dress', 'womens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 6) },
  { name: 'High-Waist Jeans', sku: 'W-002', price: 79.99, originalPrice: 99.99, category: 'jeans', gender: 'womens', image: getImagePath('High-Waist Jeans', 'womens'), tags: ['Sale'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 7) },
  { name: 'Cropped Blazer', sku: 'W-003', price: 119.99, originalPrice: null, category: 'jackets', gender: 'womens', image: getImagePath('Cropped Blazer', 'womens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 4) },
  ...
  { name: 'Silk Blouse', sku: 'W-005', price: 94.99, originalPrice: null, category: 'tops', gender: 'womens', image: getImagePath('Silk Blouse', 'womens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 5) },
  { name: 'Trench Coat', sku: 'W-006', price: 149.99, originalPrice: 199.99, category: 'jackets', gender: 'womens', image: getImagePath('Trench Coat', 'womens'), tags: ['Sale'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 3) },
  { name: 'Midi Skirt', sku: 'W-007', price: 59.99, originalPrice: null, category: 'skirts', gender: 'womens', image: getImagePath('Midi Skirt', 'womens'), tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 8) },
  { name: 'Knit Sweater', sku: 'W-008', price: 79.99, originalPrice: null, category: 'knitwear', gender: 'womens', image: getImagePath('Knit Sweater', 'womens'), tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 6) },
  ...
  { name: 'Linen Jumpsuit', sku: 'W-011', price: 94.99, originalPrice: null, category: 'jumpsuits', gender: 'womens', image: '/images/products/WOMENS-jumpsuit-linen', tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 5) },
  { name: 'Tailored Jumpsuit', sku: 'W-012', price: 119.99, originalPrice: null, category: 'jumpsuits', gender: 'womens', image: '/images/products/WOMENS-jumpsuit-tailored', tags: ['New'], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 4) },
  { name: 'Autumn Lingerie Set', sku: 'W-013', price: 49.99, originalPrice: null, category: 'lingerie', gender: 'womens', image: '/images/products/WOMENS-lingerie-autumn-set', tags: [], sizes: ['S', 'M', 'L', 'XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL'], 8) },
  { name: 'Bralette', sku: 'W-014', price: 29.99, originalPrice: null, category: 'lingerie', gender: 'womens', image: '/images/products/WOMENS-lingerie-bralette', tags: [], sizes: ['S', 'M', 'L', 'XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL'], 10) },
  { name: 'Denim Skirt', sku: 'W-015', price: 64.99, originalPrice: null, category: 'skirts', gender: 'womens', image: '/images/products/WOMENS-skirt-denim', tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 7) },
  { name: 'Cotton Top', sku: 'W-016', price: 39.99, originalPrice: null, category: 'tops', gender: 'womens', image: '/images/products/WOMENS-top-cotton', tags: [], sizes: ['S', 'M', 'L', 'XL', '2XL'], stockBySize: createStockBySize(['S', 'M', 'L', 'XL', '2XL'], 9) },
]
