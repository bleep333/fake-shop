    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {cartItems.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Link
            href="/mens"
            className="inline-block bg-black text-white px-6 py-3 rounded-md font-semibold hover:bg-stone-800 transition-colors"
          >
            Continue Shopping
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {cartItems.map((item, index) => (
              <div key={`${item.product.id}-${index}`} className="flex gap-4 border-b border-stone-200 pb-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center border border-stone-300 rounded-md">
                      <button
                        ...
                        className="px-3 py-1 hover:bg-stone-100 transition-colors focus:outline-none focus:ring-2 focus:ring-black"
                    ...
                    <button
                      ...
                      className="text-sm text-stone-600 hover:text-black transition-colors underline focus:outline-none focus:ring-2 focus:ring-black rounded"
                    >
                      Remove
                    </button>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-stone-50 rounded-lg p-6 sticky top-24">
              ...
              <Link
                href="/checkout"
                className="block w-full bg-black text-white py-3 rounded-md font-semibold hover:bg-stone-800 transition-colors mb-4 text-center focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
              >
                Checkout
              </Link>
              <Link
