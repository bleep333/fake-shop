    ...
    <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                <span className="text-gray-400 text-xs md:text-sm">Portrait 1</span>
              </div>
            </div>
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                <span className="text-gray-400 text-xs md:text-sm">Portrait 2</span>
              </div>
            </div>
            <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden">
              <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                <span className="text-gray-400 text-xs md:text-sm">Portrait 3</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 md:mb-16 max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              ...
              <p className="text-base md:text-lg text-gray-600">Shoes Tested in Motion</p>
            </div>
            <div>
              <h4 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-3 md:mb-4">50+</h4>
              <p className="text-base md:text-lg text-gray-600">Athletes & Creators Backed</p>
            </div>
            <div>
              <h4 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-3 md:mb-4">200+</h4>
              <p className="text-base md:text-lg text-gray-600">Hours of Wear Before Launch</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="aspect-[16/10] bg-gray-100 rounded-lg overflow-hidden">
            <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
              <span className="text-gray-400 text-base md:text-lg">Featured Image</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="aspect-square bg-gray-50 rounded-lg flex items-center justify-center border border-gray-200">
                <span className="text-gray-400 text-xs md:text-sm">Partner {i}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {[1, 2, 3].map((i) => (
              <a key={i} href="/new-arrivals" className="group">
                <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden mb-4">
                  <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                    <span className="text-gray-400 text-xs md:text-sm">Product {i}</span>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="aspect-square bg-gray-100 rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition-opacity">
                <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <span className="text-gray-400 text-xs">Instagram {i}</span>
                </div>
              </div>
            ))}
          </div>
